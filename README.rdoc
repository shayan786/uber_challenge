= UBER CODE CHALLENGE
<em> Note, this repository will be deleted within 2 weeks (1/6/2014) </em>

== Description / Story
This repository repesents one small 'model' of an entire peer-to-peer marketplace currently deployed as 
<a href= "http://www.advlo.com"> Adventure Local </a>
</br>
...
== Whats included & Why
For obvious reasons the entire application cannot be made public. However I have included one look into the <em> Adventure </em> MVC structure. 
</br>
This includes:
